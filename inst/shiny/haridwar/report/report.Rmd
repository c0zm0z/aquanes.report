...
plot_correlation <- function(df, 
                 ...
                 y = "Redox_Diff", 
                 xlab = "Flow (L/h)",
                 ylab = "Difference (outflow - inflow) of redox potential (mV)") {
g <- ggplot2::ggplot(tmp, aes_string(x = "Flux", 
                       y = "Redox_Diff")) +
...
## Flow vs. specific energy demand of pump

```{r, echo=FALSE, message=FALSE, warning=FALSE}
plot_correlation(tmp, y = "Pump_WhPerCbm", ylab = "Specific energy demand of pump (Wh/m3)")
